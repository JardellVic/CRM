            ...
            await Task.Run(() =>
            {
                try
                {
                    ...
                    var gruposProdutos = new Dictionary<int, List<int>>
                        {
                            { 20, new List<int> { 52836, 381, 43680, 46050, 44229 } },
                            { 30, new List<int> { 45288, 769, 745, 44188, 754, 45613, 41644, 35, 524, 522, 40969, 45288, 45049, 44503, 43299, 43298, 44899, 40707, 43284, 2982, 43550, 45049, 42780, 41991, 42868, 45080, 51517, 49510, 49511, 47545, 40931, 53434, 47578, 49537, 2060, 42421, 53379, 629, 916, 38283, 185, 38742, 511, 935, 50896, 495506, 49908, 50778, 51517, 49500, 49501, 49503, 45510, 47545, 49476, 47545, 49476,47546, 53434, 53435, 47578, 49533, 49536, 49537, 42421, 632, 630, 631, 629, 627, 628, 38292, 915, 38281, 916, 38283, 917, 38288, 185, 634, 38742, 511, 935, 936, 51531, 42652, 46042, 46043, 49678, 47196, 50816, 49513, 44273, 774, 775, 780, 370, 45754, 49677, 51350, 43548, 43549, 43547, 51664, 43552, 51346, 43546, 52504, 52633, 43550, 43551, 957, 46041, 956, 50032, 77  } },
                            { 40, new List<int> { 51531, 42652, 46042, 49678, 47196 } },
                            { 60, new List<int> { 44273, 774, 780, 49677, 51350, 43548, 44826, 49580, 50032, 1851, 44921 } },
                            { 90, new List<int> { 39050 } },
                            { 120, new List<int> { 39059 } }
                        };
